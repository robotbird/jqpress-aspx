<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="upfilemanager.ascx.cs" Inherits="Jqpress.Web.admin.controls.upfilemanager" %>
...
<div  class="right">   
    ...
    <p><asp:CheckBox ID="chkWatermark" runat="server" Text="加水印(图片)" Checked="true" /> <a href="blog_set.aspx#watermarks" class="small">水印详细设置</a> </p>
    <p>存在同名文件时:</p>
    <p> 
...
<div class="left" >
    ...
    %>
        ...
        <%if (d is DirectoryInfo)
          {%>
            <a href="<%=FileName %>?path=<%=path %><%=d.Name %>/" title="点击打开此文件夹"><img src="../images/file/folder.png"  alt="点击打开此文件夹" width="48" height="48"/></a>
             <p class="small">
        ...
        <%}
          ...
          { %>
             ...
             <%} %>
                ...
                <br />
                <span class="gray"><%=FileHelper.ConvertUnit( ((FileInfo)d).Length )%></span>
                </p>
        <%} %>
