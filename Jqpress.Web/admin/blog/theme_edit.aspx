<%@ Page Language="C#" MasterPageFile="~/admin/Blog.Master" ValidateRequest="false"  AutoEventWireup="true" CodeBehind="theme_edit.aspx.cs" Inherits="Jqpress.Web.admin.blog.theme_edit" Title="无标题页" %>
<%@ Import Namespace="Jqpress.Framework.Configuration" %>
<%@ Import Namespace="System.IO" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<div class="body_nav"><div class="left">主题编辑(<%=themeName %>)</div></div>
<%=ResponseMessage %>
<div  class="right">
    <h4>模版文件</h4>
    <ul>
    <% DirectoryInfo dir = new DirectoryInfo(Server.MapPath(ConfigHelper.SitePath + "themes/" + themeName +"/template"));
       ...
       {
    %>
        <li style="line-height:150%;"><a href="theme_edit.aspx?themename=<%=themeName %>&filepath=template/<%=f.Name %>"><%=f.Name %></a></li>
    <%} %>
    </ul>
    ...
    <ul>
            ...
            {
    %>
        <li style="line-height:150%;"><a href="theme_edit.aspx?themename=<%=themeName %>&filepath=css/<%=f.Name %>"><%=f.Name%></a></li>
    <%}
            %>
            </ul>
            <%
    ...
    %>
        <li style="line-height:150%;"><a href="theme_edit.aspx?themename=<%=themeName %>&filepath=<%=f.Name %>"><%=f.Name %></a></li>
    <%} %>
    </ul>
</div>
<div class="left" >
    ...
    <p>
        ...
        <input type="button"  onclick="location.href='theme_list.aspx'"  class="button" value="返回"/>
