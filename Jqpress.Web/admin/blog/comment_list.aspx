<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Blog.Master" AutoEventWireup="true" CodeBehind="comment_list.aspx.cs" Inherits="Jqpress.Web.admin.blog.comment_list" %>
<%@ Register Assembly="Jqpress.Blog" Namespace="Jqpress.Blog.Common" TagPrefix="jqpress" %>
<%@ Import Namespace="Jqpress.Blog.Entity.Enum" %>
            ...
            <ItemTemplate>
                <tr class="row">
                    ...
                    <a href="<%#DataBinder.Eval(Container.DataItem, "Url") %>">
                        <span title="<%#DataBinder.Eval(Container.DataItem, "Contents") %>">
                        <%# StringHelper.CutString(StringHelper.RemoveHtml(DataBinder.Eval(Container.DataItem, "Contents").ToString()), 0, 60)%>
                        </span>
                    </a>
                        <br />
                        <span class="gray small" ><%#DataBinder.Eval(Container.DataItem, "CreateTime")%></span>
                    </td>
                    ...
                    <td><%# DataBinder.Eval(Container.DataItem, "Approved").ToString()=="1" ?"<img src=\"../images/yes.gif\" title=\"已审核\"/>" : "<img src=\"../images/no.gif\" title=\"未审核\"/>"%></td>
                    <td>
                            <%#  DataBinder.Eval(Container.DataItem, "Approved").ToString()=="0"?"<a href=\"comment_list.aspx?operate=update&commentid="+DataBinder.Eval(Container.DataItem, "commentId")+"&page="+Pager1.PageIndex+"\">审核</a>":""%>
                         
                         <a href="comment_list.aspx?operate=delete&commentid=<%#DataBinder.Eval(Container.DataItem, "commentId")%>&page=<%=Pager1.PageIndex %>" onclick="return confirm('确定要删除吗?')">删除</a>   
                    </td>
                </tr>
            </ItemTemplate>
        </asp:Repeater>
