...
{
    public partial class theme_list : AdminPage
    {
        /// <summary>
        /// 主题名(文件夹名)
        /// </summary>
        protected string themename = PressRequest.GetQueryString("themename", true);
        ...
        public void CopyDir(string srcPath, string aimPath)
        {
            ...
            {
                Response.Redirect("theme_list.aspx?result=4");
            }
        }
    }
}
