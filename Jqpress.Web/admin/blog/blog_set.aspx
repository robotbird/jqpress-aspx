<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Blog.Master" AutoEventWireup="true" CodeBehind="blog_set.aspx.cs" Inherits="Jqpress.Web.admin.blog.blog_set" %>
<%@ Import Namespace="Jqpress.Framework.Configuration" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">

<style type="text/css">
 .tabnavs {height:30px;}
.tabnavs ul li{padding:1px 0; padding-left:4px; margin-left:4px; display:inline;float:left;display:block;cursor:pointer;width:80px;text-align:center;line-height:30px;height:30px;}
.tabnavs ul li.current{  -moz-border-radius:5px;-webkit-border-radius:5px;border-radius:5px;border-top:1px solid #ccc;border-left:1px solid #ccc;border-right:1px solid #ccc; border-bottom:0px; z-index:200; background:#fff transparent;}
.tabline{ border-left-color:#D0DADF;
...
var mli=document.getElementById("main").getElementsByTagName("div");
...
<div class="body_nav" style="border-bottom:0px; height:5px;"></div>

<%=ResponseMessage %>
<div class="tabnavs" >
<ul id="menu">

<li class="current" onmouseover="setTab(0)">基本设置</li>
<li onmouseover="setTab(1)">Rss设置</li>
<li onmouseover="setTab(2)">评论设置</li>
<li onmouseover="setTab(3)">显示设置</li>
<li onmouseover="setTab(4)">邮箱设置</li>
<li onmouseover="setTab(5)">邮件发送设置</li>
<li onmouseover="setTab(6)">水印设置</li>
<li onmouseover="setTab(7)">页脚设置</li>
</ul>
</div>
...
<table width="100%">
    <tr class="row">
        ...
        <td><asp:TextBox ID="txtSiteName"   Width="70%"  runat="server" CssClass="solid-text"></asp:TextBox></td>
    </tr>
    <tr class="row">
        <td><label  for="<%=txtSiteDescription.ClientID %>">网站描述:</label></td>
        <td><asp:TextBox ID="txtSiteDescription" Width="70%"   runat="server" CssClass="solid-text"></asp:TextBox></td>
    </tr>
    <tr class="row">
        <td ><label  for="<%=txtMetaKeywords.ClientID %>">Meta Keywords:</label></td>
        <td><asp:TextBox ID="txtMetaKeywords"   Width="70%"  runat="server" CssClass="solid-text"></asp:TextBox> <span class="m_desc" >首页关键字,用逗号","隔开</span></td>
    </tr>
    <tr class="row">
        <td><label  for="<%=txtMetaDescription.ClientID %>">Meta Description:</label></td>
        <td><asp:TextBox ID="txtMetaDescription" Width="70%"   runat="server" CssClass="solid-text"></asp:TextBox> <span class="m_desc" >首页描述</span></td>
    </tr>
    <tr class="row">
        <td><label  for="<%=ddlTotalType.ClientID %>">统计类型:</label></td>
        <td>
            <asp:DropDownList ID="ddlTotalType" runat="server" Width="160"  CssClass="select" >
    ...
    <tr class="row">
        ...
        <td>
             <asp:DropDownList ID="ddlRewriteExtension" runat="server" Width="160" CssClass="select">
        ...
        <tr class="row">
        <td ><label  for="<%=ddlUrlType.ClientID %>">Url地址设置:</label></td>
        <td>
             <asp:DropDownList ID="ddlUrlType" runat="server"  CssClass="select"></asp:DropDownList>
        </td>
    </tr>
    <tr class="rowend">
        <td></td>
...
<div id="tabrsss" style="display:none">
<h4 id="rsss">Rss设置</h4>
<table width="100%">
    <tr class="row">
    ...
    <tr class="row">
        ...
        <td>
                <asp:TextBox ID="txtRssRowCount"    runat="server" CssClass="solid-text"></asp:TextBox>
    ...
    <tr class="rowend">
        ...
        <td>
             <asp:DropDownList ID="ddlRssShowType" runat="server" Width="160"  CssClass="select">
...
<table width="100%">
    ...
    <tr class="row">
        ...
        <td>
                <asp:DropDownList ID="ddlCommentOrder" runat="server" Width="160"  CssClass="select">
    ...
    <tr class="row">
        ...
        <td>
                <asp:DropDownList ID="ddlCommentApproved" runat="server" Width="160"  CssClass="select">
    ...
    <tr class="rowend">
        ...
        <td>
             ...
             <p class="m_desc" >多个词语以","隔开, 当审核类型为"自动审核"时,评论包括这些关键字,则该评论转为待审核,否则审核通过</p>
        </td>
    </tr>
...
<div id="divdisplays" style="display:none">
<h4 id="displays">显示设置</h4>
<table width="90%">
    <tr class="row">
        <td  style="width:20%;"><label  for="<%=ddlPostShowType.ClientID %>">文章列表显示:</label></td>
        <td  >
            <asp:DropDownList ID="ddlPostShowType" runat="server" Width="160"  CssClass="select">
                <asp:ListItem Value="1" Text="仅标题"></asp:ListItem>
                <asp:ListItem Value="2" Text="摘要"></asp:ListItem>
                <asp:ListItem Value="3" Text="正文前200字"></asp:ListItem>
                <asp:ListItem Value="4" Text="正文"></asp:ListItem>
    ...
    <tr class="row">
        ...
        <td>
                ...
                <asp:TextBox ID="txtPageSizePostCount"    runat="server" CssClass="solid-text"></asp:TextBox>
    ...
    <tr class="row">
        ...
        <td>
                ...
                <asp:TextBox ID="txtPageSizeCommentCount" runat="server"  CssClass="solid-text"></asp:TextBox>
    ...
    <tr class="row">
        ...
        <td>
            <asp:TextBox ID="txtPostRelatedCount"    runat="server" CssClass="solid-text"></asp:TextBox>
    ...
    <tr class="row">
        ...
        <td>
                ...
                <asp:TextBox ID="txtSidebarPostCount"    runat="server" CssClass="solid-text"></asp:TextBox>
    ...
    <tr class="row">
        ...
        <td>
                ...
                <asp:TextBox ID="txtSidebarCommentCount"    runat="server" CssClass="solid-text"></asp:TextBox>
    ...
    <tr class="rowend">
        ...
        <td>
                ...
                <asp:TextBox ID="txtSidebarTagCount"   runat="server" CssClass="solid-text"></asp:TextBox>
...
<table width="100%">
    ...
    <tr class="row">
        ...
        <td>
            <asp:TextBox ID="txtSmtpServer"  runat="server" CssClass="solid-text"></asp:TextBox>
    ...
    <tr class="row">
        ...
        <td>
            <asp:TextBox ID="txtSmtpServerPort"   runat="server" CssClass="solid-text"></asp:TextBox>
    ...
    <tr class="row">
        ...
        <td>
            <asp:TextBox ID="txtSmtpEmail"   runat="server" CssClass="solid-text"></asp:TextBox>
    ...
    <tr class="row">
        ...
        <td>
            <asp:TextBox ID="txtSmtpUserName"  runat="server" CssClass="solid-text"></asp:TextBox>
    ...
    <tr class="row">
        ...
        <td>
            <asp:TextBox ID="txtSmtpPassword" runat="server" CssClass="solid-text"></asp:TextBox>
    ...
    <tr class="rowend">
        <td>&nbsp;</td>
        <td>
           <label class="" for="<%=txtTestEmail.ClientID %>">测试邮箱:</label> <asp:TextBox ID="txtTestEmail" runat="server" CssClass="solid-text"></asp:TextBox>
           <asp:Button ID="btnTestSend" CssClass="button" runat="server"   Text="发送测试邮件"  OnClick="btnTestSend_Click" TabIndex="999" UseSubmitBehavior="false"  />
...
<div id="tabemailsends" style="display:none">
...
<div id="tabwatermarks" style="display:none">
...
<table width="100%">
        <tr class="row">
            ...
            <td>
                 <asp:DropDownList ID="ddlWatermarkType" runat="server" Width="160"  CssClass="select">
        ...
        <tr class="row">
            ...
            <td>
                <asp:TextBox ID="txtWatermarkText"    runat="server" CssClass="solid-text"></asp:TextBox>
        ...
        <tr class="row">
            ...
            <td>
                  <asp:DropDownList ID="ddlWatermarkFontName" runat="server" Width="160"  CssClass="solid-text"></asp:DropDownList>
            </td>
        </tr>
        <tr class="row">
            <td><label class="" for="<%=ddlWatermarkFontSize.ClientID %>">文字型水印大小:</label></td>
            <td>
                    <asp:DropDownList ID="ddlWatermarkFontSize" runat="server" Width="160" CssClass="select">
        ...
        <tr class="row">
            ...
            <td>
                <asp:TextBox ID="txtWatermarkImage"    runat="server" CssClass="solid-text"></asp:TextBox>
        ...
        <tr class="row">
            ...
            <td>
                  <asp:DropDownList ID="ddlWatermarkPosition" runat="server" Width="160" CssClass="select">
        ...
        <tr class="rowend">
            ...
            <td>               
                  <asp:DropDownList ID="ddlWatermarkQuality" runat="server" Width="160" CssClass="select"></asp:DropDownList>
...
<div id="tabfooters" style="display:none">
...
<table width="100%">
  ...
  <div style="margin:0px auto"><asp:Button ID="btnEdit" CssClass="button" runat="server" OnClick="btnEdit_Click" Text="保存"  /></div>
